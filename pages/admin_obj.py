# pages/admin_obj.py - Admin Objectives Page with HR Directives Style
...
from database import (
    get_all_admin_objectives,
    save_admin_evaluation_with_evidence,
    get_admin_finance_years,
    get_admin_finance_amount_by_year
)

def admin_page():
    objectives = get_all_admin_objectives()
    finance_years = get_admin_finance_years()
    
    # The 7 Admin Objectives
    admin_objectives_data = [
        {
            "id": 1,
            "objective_id": "ADM-01",
            "category": "Administration",
            "objective": "Ensure timely procurement of office supplies",
            "kpi": "% procurement completed within timeline",
            "target": "95%",
            "timeline": "Monthly",
            "responsible_personnel": "",
            "previous_achievement": "",
            "current_achievement": "98.00%",
            "variance": "",
            "trend": "",
            "status": "On Track",
            "evidence": "",
        ...
        },
        {
            ...
            "objective_id": "ADM-02",
            "category": "Facilities",
            "objective": "Maintain office facilities and infrastructure",
            "kpi": "% facility maintenance compliance",
            "target": "100%",
            "timeline": "Monthly",
            "responsible_personnel": "",
            "previous_achievement": "",
            "current_achievement": "97.00%",
            "variance": "",
            "trend": "",
            "status": "At Risk",
            "evidence": "",
        ...
        },
        {
            ...
            "objective": "Track and manage company assets",
            "kpi": "% asset inventory accuracy",
            "target": "100%",
            "timeline": "Quarterly",
            "responsible_personnel": "",
            "previous_achievement": "",
            "current_achievement": "99.00%",
            "variance": "",
            "trend": "",
            "status": "On Track",
            "evidence": "",
        ...
        },
        {
            ...
            "objective": "Maintain and update administrative records",
            "kpi": "% documentation completeness",
            "target": "95%",
            "timeline": "Quarterly",
            "responsible_personnel": "",
            "previous_achievement": "85.0",
        ...
        },
        {
            ...
            "objective_id": "ADM-05",
            "category": "Transport",
            "objective": "Manage fleet and transportation services",
            "kpi": "% vehicle utilization rate",
            "target": "90%",
            "timeline": "Monthly",
            "responsible_personnel": "",
            "previous_achievement": "88.0",
            "current_achievement": "95.0",
            "variance": "5.0",
            "trend": "↑ Improving",
            "status": "On Track",
            "evidence": "",
        ...
        },
        {
            ...
            "objective_id": "ADM-06",
            "category": "Security",
            "objective": "Ensure office security and safety",
            "kpi": "% security compliance",
            "target": "100%",
            "timeline": "Monthly",
            "responsible_personnel": "",
            "previous_achievement": "",
            "current_achievement": "96.00%",
            "variance": "",
            "trend": "",
            "status": "At Risk",
            "evidence": "",
        ...
        },
        {
            ...
            "objective_id": "ADM-07",
            "category": "Administration",
            "objective": "Improve administrative process efficiency",
            "kpi": "Process improvement score",
            "target": "70%",
            "timeline": "Annual",
            "responsible_personnel": "",
            "previous_achievement": "65.0",
            "current_achievement": "72.0",
            "variance": "2.0",
            "trend": "↑ Improving",
            "status": "On Track",
            "evidence": "",
    ...
    total = len(admin_objectives_data)
    on_track = len([o for o in admin_objectives_data if o.get('status') == 'On Track'])
    at_risk = len([o for o in admin_objectives_data if o.get('status') == 'At Risk'])
    attention_needed = 43
    not_started = 0
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    html.H1(
                        "Admin Directives Monitoring Table",
                        style={
                            'fontSize': '24px',
                            'fontWeight': '700',
                            'color': '#1e293b',
                    ...
                    html.P(
                        "Track and monitor Admin objectives and directives",
                        style={
                            'fontSize': '14px',
                            'color': '#64748b',
                            'margin': 0
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div([
                        ...
                        html.Div("ADM/JHR/TMP/OBM/V3.0", style={'fontSize': '13px', 'fontWeight': '600', 'color': '#1e293b', 'marginTop': '4px'})
                    ]),
                    html.Div([
                                ...
                                children=[
                                    ...
                                    html.Div(
                                        ...
                                        children=[
                                            ...
                                            html.Div(id="admin-eval-evidence-name", style={'fontSize': '12px', 'marginTop': '6px', 'color': '#10b981'})
                                        ]
                                    ),
            ...
            html.Div([
                ...
                <style>
                    ...
                    #cancel-admin-eval-modal:hover {
                        background: #e2e8f0;
                    }
                    
                    #save-admin-evaluation:hover {
                        transform: translateY(-2px);
                        box-shadow: 0 8px 25px rgba(102, 126, 234, 0.3);
                    }
                    
                    #close-admin-eval-modal:hover {
                        color: #ef4444;
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.I(className="fas fa-times", id="close-admin-evidence-modal", style={'cursor': 'pointer', 'color': '#94a3b8'})
                                ]
                            ),
                            html.Div(id="admin-evidence-content", style={'padding': '20px'})
                        ]
                    )
                ]
            ),
            ...
            # Stores
            dcc.Store(id="admin-objectives-store", data=admin_objectives_data),
            dcc.Store(id="admin-selected-objective-id", data=None),
            dcc.Store(id="admin-modal-trigger", data=0),
            dcc.Store(id="admin-page-loaded", data=0)
        ]
    )
...
def register_admin_callbacks(app):
    ...
    @app.callback(
        [Output("admin-table-body", "children")],
        [Input("admin-objectives-store", "data"),
    ...
    def update_table(objectives, search_term):
        ...
        for obj in filtered:
            ...
            evaluate_btn = html.Button(
                "Evaluate",
                id={"type": "evaluate-admin", "index": obj.get('id', 0)},
    ...
    @app.callback(
        Output("admin-page-loaded", "data"),
        Input("admin-table-body", "children"),
    ...
    # AUTO-FILL
    @app.callback(Output("admin-eval-data-entry", "value", allow_duplicate=True), 
                  [Input("admin-eval-year-select", "value")], 
                  prevent_initial_call=True)
    def auto_fill(selected_year):
        if selected_year:
            amount = get_admin_finance_amount_by_year(selected_year)
            return amount if amount else None
        return None
    
    # SHOW FILENAME
    @app.callback(Output("admin-eval-evidence-name", "children"), 
                  [Input("admin-eval-evidence", "filename")])
    ...
    # Set trigger when evaluate button is clicked
    @app.callback(
        Output("admin-modal-trigger", "data"),
        [Input({"type": "evaluate-admin", "index": dash.dependencies.ALL}, "n_clicks")],
        [State("admin-page-loaded", "data")],
        prevent_initial_call=True
    )
    def set_trigger(clicks, page_loaded):
        if page_loaded:
            ...
            if ctx.triggered:
                ...
                if "evaluate-admin" in trigger_id:
                    match = re.search(r'"index":(\d+)', trigger_id)
                    if match:
                        return int(match.group(1))
        return 0
    
    # Open modal based on trigger
    @app.callback(
        [Output("admin-eval-modal", "style"),
         Output("admin-eval-modal-title", "children"),
         Output("admin-eval-objective-info", "children"),
         Output("admin-selected-objective-id", "data")],
        [Input("admin-modal-trigger", "data"),
         Input("close-admin-eval-modal", "n_clicks"),
         Input("cancel-admin-eval-modal", "n_clicks")],
        [State("admin-objectives-store", "data"),
         State("admin-page-loaded", "data")],
        prevent_initial_call=True
    )
    def open_modal(trigger_id, close_clicks, cancel_clicks, objectives, page_loaded):
        ...
        # Close modal
        if trigger in ["close-admin-eval-modal", "cancel-admin-eval-modal"]:
            return {"display": "none"}, "", html.Div(), None
        
        # Open modal only if page is loaded and trigger is valid
        if trigger == "admin-modal-trigger" and page_loaded and trigger_id and trigger_id > 0:
            for obj in objectives:
                if obj.get('id') == trigger_id:
                    ...
                    return {"display": "flex"}, f"Evaluate: {obj.get('objective_id', '')}", info, obj.get('id')
        
        return {"display": "none"}, "", html.Div(), None
    
    # Clear modal inputs when closed
    @app.callback(
        [Output("admin-eval-data-entry", "value", allow_duplicate=True),
         Output("admin-eval-reviewed-by", "value", allow_duplicate=True),
         Output("admin-eval-remarks", "value", allow_duplicate=True),
         Output("admin-eval-year-select", "value", allow_duplicate=True),
         Output("admin-eval-evidence", "contents", allow_duplicate=True),
         Output("admin-eval-evidence", "filename", allow_duplicate=True),
         Output("admin-eval-evidence-text", "value", allow_duplicate=True),
         Output("admin-modal-trigger", "data", allow_duplicate=True)],
        [Input("close-admin-eval-modal", "n_clicks"),
         Input("cancel-admin-eval-modal", "n_clicks")],
        prevent_initial_call=True
    )
    ...
    # CALCULATE RESULT
    @app.callback(Output("admin-calc-result", "children"), 
                  [Input("admin-eval-data-entry", "value")], 
                  [State("admin-selected-objective-id", "data"), State("admin-objectives-store", "data")])
    def calculate(data_entry, obj_id, objectives):
        if not data_entry or not obj_id or not objectives:
            return html.Div()
        obj = next((o for o in objectives if o.get('id') == obj_id), None)
        if not obj:
            return html.Div()
        prev = obj.get('previous_achievement', 0) or 0
        try:
            prev_val = float(str(prev).replace('%', '')) if prev else 0
        except:
            prev_val = 0
        ...
        if prev_val > 0:
            ...
            growth, pct = 0, 100 if actual > 0 else 0
    ...
    # SAVE EVALUATION
    @app.callback(
        [Output("admin-eval-modal", "style", allow_duplicate=True), 
         Output("admin-success-toast", "style"), 
         Output("admin-objectives-store", "data")],
        [Input("save-admin-evaluation", "n_clicks")],
        [State("admin-selected-objective-id", "data"), State("admin-eval-data-entry", "value"), 
         State("admin-eval-reviewed-by", "value"), State("admin-eval-remarks", "value"), 
         State("admin-eval-evidence", "filename"), State("admin-eval-evidence", "contents"),
         State("admin-eval-evidence-text", "value"), State("admin-objectives-store", "data")], 
        prevent_initial_call=True
    )
    def save_eval(n_clicks, obj_id, data_entry, reviewed_by, remarks, filename, contents, text, objectives):
        ...
        success = save_admin_evaluation_with_evidence(obj_id, data_entry, reviewed_by, remarks, final_filename, evidence_content, text)
        if success:
            from database import get_all_admin_objectives
            return {"display": "none"}, {"display": "flex", "position": "fixed", "bottom": "20px", "right": "20px", "zIndex": "10000", "background": "#10b981", "color": "white", "padding": "12px 20px", "borderRadius": "10px", "alignItems": "center", "gap": "10px", "fontWeight": "500", "boxShadow": "0 8px 25px rgba(16, 185, 129, 0.3)"}, get_all_admin_objectives()
        return {"display": "none"}, {"display": "none"}, objectives
    
    # VIEW EVIDENCE
    @app.callback(
        [Output("admin-evidence-view-modal", "style"), Output("admin-evidence-content", "children")],
        [Input({"type": "view-admin-evidence", "index": dash.dependencies.ALL}, "n_clicks"), 
         Input("close-admin-evidence-modal", "n_clicks")],
        [State("admin-objectives-store", "data")], prevent_initial_call=True
    )
    def view_evidence(view_clicks, close_clicks, objectives):
        ...
        if trigger_id == "close-admin-evidence-modal":
            return {"display": "none"}, html.Div()
        if trigger_id and "view-admin-evidence" in trigger_id:
            try:
                match = re.search(r'"index":(\d+)', trigger_id)
    ...
    # HIDE TOAST
    @app.callback(Output("admin-success-toast", "style", allow_duplicate=True), 
                  [Input("admin-success-toast", "style")], 
                  prevent_initial_call=True)
